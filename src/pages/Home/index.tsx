    ...
    <div className="max-w-screen w-full overflow-x-hidden">
      ...
      >
        <div className="flex flex-col w-full max-w-7xl">
          <h1
            className="text-white mb-10 text-3xl font-medium max-w-sm"
            data-aos="fade-right"
          ...
          <div className="flex gap-5 flex-wrap justify-center lg:justify-start">
            <div data-aos="fade-left" data-aos-duration="2800">
            ...
            <div data-aos="fade-left" data-aos-duration="2900">
              <div className="w-full sm:max-w-sm bg-black rounded-lg p-10 h-75 hover:scale-105 duration-300 ease-in-out border border-solid border-[#a1999918]">
                <div className="bg-[#000000] border border-solid border-[#f0a] w-10 h-10 flex items-center justify-center rounded-lg">
      ...
      <div
        className="min-h-screen bg-black flex items-center justify-center lg:pl-25 md:pl-5 sm:pl-5"
        id="platform"
      >
        <div className="flex flex-col lg:flex-row gap-10 max-w-7xl w-full">
          ...
          <div className="flex flex-col gap-5 w-full lg:max-w-lg justify-center">
            <div data-aos="fade-left" data-aos-duration="2800">
              <div className="lg:mt-37 hover:scale-105 duration-300 ease-in-out bg-black text-white border border-solid border-[#a1999918] p-8.5 rounded-lg">
            ...
            <div data-aos="fade-left" data-aos-duration="2900">
              <div className="hover:scale-105 duration-300 ease-in-out bg-black text-white border border-solid border-[#a1999918] p-8.5 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  <MdCheckCircleOutline className="text-lg text-[#f0a]" />
